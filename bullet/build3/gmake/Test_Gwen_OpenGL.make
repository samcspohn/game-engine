...
ifeq ($(config),release64)
  ...
  DEFINES   += -DGWEN_COMPILE_STATIC -D_HAS_EXCEPTIONS=0 -D_STATIC_CPPLIB -DDONT_USE_GLUT -DGLEW_INIT_OPENGL11_FUNCTIONS=1 -DDYNAMIC_LOAD_X11_FUNCTIONS -DGLEW_DYNAMIC_LOAD_ALL_GLX_FUNCTIONS=1 -DGLEW_STATIC
  INCLUDES  += -I../../examples/ThirdPartyLibs -I../../examples -I../../test/GwenOpenGLTest -I../../src -I../../examples/ThirdPartyLibs/optionalX11 -I../../examples/ThirdPartyLibs/glad
...
ifeq ($(config),debug64)
  ...
  DEFINES   += -D_DEBUG=1 -DGWEN_COMPILE_STATIC -D_HAS_EXCEPTIONS=0 -D_STATIC_CPPLIB -DDONT_USE_GLUT -DGLEW_INIT_OPENGL11_FUNCTIONS=1 -DDYNAMIC_LOAD_X11_FUNCTIONS -DGLEW_DYNAMIC_LOAD_ALL_GLX_FUNCTIONS=1 -DGLEW_STATIC
  INCLUDES  += -I../../examples/ThirdPartyLibs -I../../examples -I../../test/GwenOpenGLTest -I../../src -I../../examples/ThirdPartyLibs/optionalX11 -I../../examples/ThirdPartyLibs/glad
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
