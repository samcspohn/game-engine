...
//     player->addComponent<Light>()->setColor(glm::vec3(0,0,1));
//     player->getComponent<Light>()->setConstant(1.f);
//     player->getComponent<Light>()->setlinear(0.09f);
//     player->getComponent<Light>()->setQuadratic(0.032f);
...
// 			light->transform->setPosition(glm::vec3(i * 2 - 10,-0.5f, j * 2 - 10));
// 			light->addComponent<Light>()->setColor(glm::vec3(randf(),randf(),randf()));
// 			light->getComponent<Light>()->setConstant(1.f);
//             light->getComponent<Light>()->setlinear(0.7f);
//             light->getComponent<Light>()->setQuadratic(1.8f);
// 		}
// 	}
//     {
//         game_object* light = new game_object();
//         light->transform->setPosition(glm::vec3(30));
//         light->addComponent<Light>()->setColor(glm::vec3(1));
//         light->getComponent<Light>()->setConstant(1.f);
//         light->getComponent<Light>()->setlinear(0.0014f);
